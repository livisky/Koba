...
define(function(require) {
    var createClass = require('common/createClass/0.0.1/createClass'),
        Layer       = require('common/layer/0.0.1/layer');
    
    var template = [
        '<div class="sea1411-tip" style="display:none">',
            '<div class="sea1411-tip-bd"></div>',
            '<span class="sea1411-tip-arrow">',
                '<span>◆</span>',
                '<i>◆</i>',
            '</span>',
        '</div>'
        ...
        methods: {
            ...
            setTheme: function(themeName) {
                ...
                widgetEle.removeClass()
                         .addClass('sea1411-tip-theme-' + themeName);
